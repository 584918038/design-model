...
//        gc.setBaseResultMap(true);
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/guns_rest?userUnicode=true&characterEncoding=utf8&pinGlobalTxToPhysicalConnection=true");
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.p6.demo.trasaction")
                .setMapper("mapper")
                .setService("service")
...
//        strategy.setSuperMapperClass("com.baomidou.mybatisplus.core.mapper.BaseMapper");
        strategy.setInclude(scanner("user_channel").split(","));
